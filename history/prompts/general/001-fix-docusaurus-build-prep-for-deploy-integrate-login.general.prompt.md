---
id: 001
title: Fix Docusaurus build, prep for deploy, integrate login
stage: general
date: 2025-12-05
surface: agent
...
user: madna
command: git push
labels: ["docusaurus", "build-fix", "deployment", "login-integration"]
links:
  spec: null
  ticket: null
  adr: null
...
- frontend/docs/module1.md
- frontend/docs/module1_chapter1.md
- frontend/docs/module2.md
- frontend/docs/module2_chapter2.md
- frontend/docusaurus.config.ts
- frontend/package-lock.json
- frontend/package.json
- frontend/sidebars.ts
- frontend/src/components/PythonRunner.tsx
- frontend/src/components/RobotArm2D.tsx
- frontend/src/hooks/useAuth.ts
- frontend/src/pages/login.md (deleted)
- backend/requirements.txt (created)
- backend/start_uvicorn.ps1 (created)
- frontend/docs/login.md (created)
- frontend/src/components/LoginForm.module.css (created)
- frontend/src/components/LoginForm.tsx (created)
- frontend/src/theme/MDXComponents.tsx (modified)
